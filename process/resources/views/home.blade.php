...
<br/><br/>
                <!-- Button -->
                <div class="form-group">
                  <label class="col-md-4 control-label" for="singlebutton">Submit Form</label>
                  <div class="col-md-4">
                    <button style="padding: 10px;" id="singlebutton" name="singlebutton" class="btn btn-primary">Submit</button>
